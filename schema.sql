...
create table
  public.shop_ledger (
    ...
    constraint shop_ledger_pkey primary key (id),
    constraint public_shop_ledger_customer_id_fkey foreign key (customer_id) references customers (id),
    constraint public_shop_ledger_transaction_id_fkey foreign key (transaction_id) references shop_transactions (id)
  ) tablespace pg_default;

create table
  public.shop_transactions (
    id bigint generated by default as identity,
    created_at timestamp with time zone not null default now(),
